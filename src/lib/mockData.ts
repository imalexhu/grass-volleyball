...
export const tournaments: Tournament[] = [
  {
    ...
    entryFee: 80,
    description: "Enjoy a day of competitive and social grass volleyball at the Glenelg Foreshore with top-tier players and a vibrant atmosphere.",
    maxTeams: 8,
  ...
  },
  {
    ...
    format: "Pool Play + Finals",
    entryFee: 70,
    description: "A grassroots community cup focused on relaxed competition and socializing.",
    maxTeams: 8,
    registeredTeams: sampleTeams(8),
    status: "complete",
  },
  {
    ...
    format: "Pool Play + Finals",
    entryFee: 70,
    description: "Experience the cool temperatures and fierce competition at Hahndorf Oval.",
    maxTeams: 8,
    registeredTeams: sampleTeams(8),
    status: "complete",
  },
  {
    ...
    format: "Pool Play + Finals",
    entryFee: 80,
    description: "Warm up for the upcoming winter season with this open format tournament.",
    maxTeams: 8,
